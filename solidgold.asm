  include "blitz.i"
	...
	libheader $14,0,0,blitz_finit,0
	; BB2 library header
  ...
  astatement
    ...
    libs
    subs _td_init,0,0
  name "TD_Init","Chipram buffer of $1a00*2 bytes, Directory buffer of 512 bytes, OPTIONAL writebuffer of 11*512 bytes"	
 ...
 afunction long
    ...
    libs
    subs _td_write,0,0
  name "TD_Write","FirstBlock NumBlock Source (Returns Error). Block=512 bytes"
...
; a0 and a1 are reserved!
	;; move.w	#INTF_COPER,INTENA(a6)
.1:	move.b	VHPOSR(a6),d1
.2:	cmp.b	VHPOSR(a6),d1
	beq	.2
	subq.w	#1,d0
	bne	.1
	;; move.w	#((1<<15)|INTF_COPER),INTENA(a6)
	rts
